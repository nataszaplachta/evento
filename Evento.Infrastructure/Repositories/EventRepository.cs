...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        {
            new Event(Guid.NewGuid(), "event1","event description", DateTime.UtcNow.AddHours(2), DateTime.UtcNow.AddHours(4)),
            new Event(Guid.NewGuid(), "event2","event description", DateTime.UtcNow.AddHours(5), DateTime.UtcNow.AddHours(10))
